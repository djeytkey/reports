		...
		class pw_rpt_datatable_generate{
			...
			public function fetch_sql($table_name,$search_fields=NULL){
				...
				switch($table_name){
					...
					case 'stock_list_sales':
						require("fetch_data_stock_list_sales.php");
					break;
...
//							array('lable'=>esc_html__('Email',__PW_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
			...
			public function table_html($table_name,$search_fields=NULL){
				...
				$page_titles=array(
					...
					'stock_list_sales'			  => esc_html__( "Stock List Sales",__PW_REPORT_WCREPORT_TEXTDOMAIN__),
			...
			public function table_html_pdf($table_name,$search_fields=NULL,$selected_columns){
				...
				if($table_name=='refunddetails')
				{
					$refund_type=$this->refund_status;
					$this->table_cols =$this->table_columns($refund_type);
				}else if( in_array ( $table_name,array('details','details_depot','details_full','details_full_shipping','details_full_shipping_tax','abandoned_cart','abandoned_product','details_product_options','product','product_per_users','category','tags','details_order_country','details_brands','details_tax_field','prod_per_month','variation_per_month','prod_per_country','prod_per_state','country_per_month','payment_per_month','ord_status_per_month','summary_per_month','variation','stock_summary_avg','stock_list','stock_list_sales','variation_stock','tax_reports','customer_role_total_sale','customer_role_top_products','customer_role_bottom_products','details_tickera','stock_zero_level','stock_max_level') ) )
				{
					//$this->table_cols =$this->table_columns($table_name);
				}else{
