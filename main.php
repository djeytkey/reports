...
where pitems.order_id='$order_id' AND pmeta.meta_key='_wc_eco_fields_value' AND pmeta_p.meta_key='_wc_eco_element_id' AND pmeta_p.meta_value='$field'";
        ...
        //Details
        function wcx_plugin_menu_details_depot()
        {
            $this->pages_fetch("details_depot.php");
        }
            ...
            $this->our_menu = array(
                ...
                "all_order_reports" => array(
                    ...
                    "childs" => array(
                        ...
                        "all_orders_depot"               => array(
                            "label" => esc_html__('تقرير المبيعات للمستودع', __PW_REPORT_WCREPORT_TEXTDOMAIN__),
                            "id"    => "all_orders_depot",
                            "link"  => "admin.php?page=wcx_wcreport_plugin_details_depot&parent=all_order_reports&smenu=all_orders_depot",
                            "icon"  => "fa-file-text",
                        ),
                        //CUSTOM WORK - 12300
...
//				),
                ...
                "product_reports" => array(
                    ...
                    "childs" => array(
                        ...
                        "stock_list_sales"        => array(
                            "label" => esc_html__('Product Stock Sales', __PW_REPORT_WCREPORT_TEXTDOMAIN__),
                            "id"    => "stock_list_sales",
                            "link"  => "admin.php?page=wcx_wcreport_plugin_stock_list_sales&parent=product_reports&smenu=stock_list_sales",
                            "icon"  => "fa-cart-arrow-down",
                        ),
...
//				),
        ...
        function wcx_plugin_menu_stock_list_sales()
        {
            $this->pages_fetch("stock_list_sales.php");
        }
